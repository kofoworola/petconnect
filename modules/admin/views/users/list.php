                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('business_type') ?></th>
                        ...
                        <?php if (isset($users)): ?>
                            <tbody>
                                ...
                                foreach ($users as $new) {
                                    ?>
                                    <tr class="gc_row">
                                        <td><?php echo $this->user_model->convert_id($new->user_type, $new->id); ?></td>
                                        <td><?php echo ucwords($new->name) ?></td>
                                        <td><?php echo $new->contact ?></td>
                                        <td><?php echo $this->user_model->get_type($new->user_type) ?></td>
                                        <td width="41%">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/users/delete/' . $new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete') ?></a>
                                            </div>
...
<?php if (isset($users)): ?>
    ...
    $i = 1;
    foreach ($users as $new) {
        $user = $this->user_model->get_user_by_id($new->id);
        ?>
        <!-- Modal -->
                    ...
                    <div class="modal-body">
                                ...
                                if ($doc->field_type == 1) { //testbox
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <?php $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $user->id . "' AND form = '" . $doc->form . "' ")->row(); ?>		
                                ...
                                if ($doc->field_type == 2) { //dropdown list
                                    ...
                                    ?>	<div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">	
                                                <?php $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $user->id . "'  ")->row(); ?>	
                                                <?php
                                                $values = array();
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">	
                                                ...
                                                <?php foreach ($values as $key => $val) { ?>
                                                    <?php
                                                    $x = "";
                                                    $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $user->id . "' AND form = '" . $doc->form . "' ")->row();
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">		
                                    <?php echo $this->user_model->get_type($user->user_type) ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="name" style="clear:both;"><?php echo lang('name') ?></label>
                                            <input type="text" name="name" value="<?php echo $user->name ?>" class="form-control name">
                                        </div>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="email" style="clear:both;"><?php echo lang('email') ?></label>
                                            <input type="text" name="email" value="<?php echo $user->email ?>" class="form-control email">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="username" style="clear:both;"><?php echo lang('username') ?></label>
                                            <input type="text" name="username" value="<?php echo $user->username ?>" class="form-control username">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="user_type" style="clear: both"><?php echo lang('business_type'); ?></label>
                                            <select name="user_type" class="form-control user_type">
                                                <option value="clinics" <?php echo ($user->user_type == 'clinics') ? 'selected' : ''; ?>><?php echo lang('clinic') ?></option>
                                                <option value="business" <?php echo ($user->user_type == 'business') ? 'selected' : ''; ?>><?php echo lang('business') ?></option>
                                                <option value="non-profit" <?php echo ($user->user_type == 'non-profit') ? 'selected' : ''; ?>><?php echo lang('profit') ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="contact" style="clear:both;"><?php echo lang('phone') ?></label>
                                            <input type="text" name="contact" value="<?php echo $user->contact ?>" class="form-control contact">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="contact" style="clear:both;"><?php echo lang('address') ?></label>
                                            <textarea name="address"  class="form-control address"><?php echo $user->address ?></textarea>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content ff">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="addlabel"><?php echo lang('add'); ?> <?php echo lang('user_account') ?></h4>
            </div>
            <div class="modal-body">
                <div id="err">  
                    <?php
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="fname" value="<?php echo set_value('name') ?>" class="form-control fname">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="lname" value="<?php echo set_value('name') ?>" class="form-control lname">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-8">
                                    <label for="email" style="clear:both;"><?php echo lang('email') ?></label>
                                    <input type="email" name="email" value="<?php echo set_value('email') ?>" class="form-control email">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-8">
                                    <label for="user_type" style="clear: both"><?php echo lang('business_type'); ?></label>
                                    <select name="user_type" class="form-control user_type">
                                        <option value="clinics"><?php echo lang('clinic') ?></option>
                                        <option value="business"><?php echo lang('business') ?></option>
                                        <option value="non-profit"><?php echo lang('profit') ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(".update").click(function (event) {
            ...
            call_loader_ajax();
            $.ajax({
                url: '<?php echo site_url('admin/users/edit') ?>/' + id,
                type: 'POST',
                data: form.serialize(),
