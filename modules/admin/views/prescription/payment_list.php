                                            ...
                                            <table width="100%" style="border-bottom:1px solid #CCCCCC; padding-bottom:20px;">
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        ...
                                                        <b><?php echo lang('payment_mode') ?>:</b> <?php echo $details->payment_mode ?><br/>
                                                        <b>Issue Date:</b> <?php echo date('m/d/Y') ?><br />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                if ($admin['user_role'] == 2) {
                                    ...
                                    <div class="row no-print">
                                        <div class="col-xs-12">
                                            ...
                                            <a target="_blank" href="<?php echo site_url('admin/invoice/pdf/' . $details->id) ?>"class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> <?php echo lang('generate_pdf') ?></a>
                                            <a target="_blank" href="<?php echo site_url('admin/invoice/mail/' . $details->id) ?>"class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-mail-forward"></i> <?php echo lang('mail_to_patient') ?></a>
                                        </div>
                                    </div>
                                <?php } else { ?>	
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select name="patient_id" id="patient_id" class="form-control chzn patient patient_id " <?php echo (!empty($p_id)) ? 'disabled' : ''; ?>  >
                                        <option value="">--<?php echo lang('select_patient'); ?>--</option>
                                        <?php
                                        foreach ($pateints as $new) {
                                            $sel = "";
                        ...
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="number" name="amount" value="" id="amount" class="form-control amount" />
                        ...
                        <div class="form-group" id="stripe">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div id="generated" style="margin-top: 30px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="paypal" style="display: none">
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="#" class="btn btn-primary" id="generate-paypal">Generate Invoice</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e)
    {
        ...
        $("#generate-paypal").click(function (e)
        {
            e.preventDefault();
            var form = $(this).closest('form');
