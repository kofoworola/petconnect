                            ...
                            <tbody>
                                ...
                                foreach ($payments as $new) {
                                    ...
                                    <tr class="gc_row">
                                        ...
                                        <td><?php echo date("m/d/y", strtotime($new->date)) ?></td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" style="border-bottom:1px solid #CCCCCC; padding-bottom:20px;">
                                                <tr>
                                                    <td align="left"><?php if ($new->image != "") { ?>
                                                            <img src="<?php echo base_url('assets/uploads/images/' . $new->image) ?>"  height="70" width="80" />
                                                        <?php } else { ?>
                                                    ...
                                                    <td align="right">
                                                        ...
                                                        <b>Payment Date:</b> <?php echo date("m/d/Y", strtotime($details->date)); ?><br />
                                            ...
                                            <table width="100%" border="0" style="border-bottom:1px solid #CCCCCC; padding-bottom:30px;">
                                                <tr>
                                                    <td align="left"><?php echo lang('payment_to') ?><br />
                                                        <strong><?php echo $new->name ?></strong><br>
                                                        <?php echo $new->address ?><br>
                                                        <?php echo lang('phone') ?>: <?php echo $new->contact ?><br/>
                                                        <?php echo lang('email') ?>: <?php echo $new->email ?>		
