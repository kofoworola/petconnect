...
<script type="text/javascript">
    function areyousure()
    {
        return confirm('Are You Sure You Want Delete This Business');
    }
</script>
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo lang('businesses') ?></li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('businesses') ?></h3>                                    
                </div><!-- /.box-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php if (isset($businesses)): ?>
                            <tbody>
                                <?php
                                $i = 1;
                                foreach ($businesses as $new) {
                                    ?>
                                    <tr class="gc_row">
                                        <td><?php echo $this->business_model->convert_id($new->id); ?></td>
                                        ...
                                        <td width="41%">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/business/delete/' . $new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete') ?></a>
...
<?php if (isset($businesses)): ?>
    ...
    $i = 1;
    foreach ($businesses as $new) {
        $business = $this->business_model->get_business_by_id($new->id);
        ?>
        <!-- Modal -->
                                ...
                                if ($doc->field_type == 1) { //testbox
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <?php $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $business->id . "' AND form = '" . $doc->form . "' ")->row(); ?>		
                                ...
                                if ($doc->field_type == 2) { //dropdown list
                                    ...
                                    ?>	<div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">	
                                                <?php $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $business->id . "'  ")->row(); ?>	
                                                <?php
                                                $values = array();
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">	
                                                ...
                                                <?php foreach ($values as $key => $val) { ?>
                                                    <?php
                                                    $x = "";
                                                    $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $business->id . "' AND form = '" . $doc->form . "' ")->row();
