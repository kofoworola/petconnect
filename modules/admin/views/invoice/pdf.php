<?php
if ($setting->image != "") {
    $img = '<img src="' . site_url('assets/uploads/images/' . $setting->image) . '"  height="70" width="80" />';
} else {
    $img = '<img src="' . site_url('assets/img/doctor_logo.png') . '"  height="70" width="80" />';
}
?>	<table width="100%" border="0"  id="print_inv<?php echo $details->id ?>" class="bd" >
    <tr>
        <td>
            <table width="100%" style="border-bottom:1px solid #CCCCCC; padding-bottom:20px;">
                <tr>
                    ...
                    <td align="right">
                        ...
                        <b><?php echo lang('issue_date') ?>:</b> <?php echo date('m/d/Y') ?><br />
                    </td>
                </tr>
            </table>
        </td>
