...
<script type="text/javascript">
    function areyousure()
    {
        return confirm('Are You Sure You Want Delete This Non-Profit Organization');
    }
</script>
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo lang('profits') ?></li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('profits') ?></h3>                                    
                </div><!-- /.box-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php if (isset($profits)): ?>
                            <tbody>
                                <?php
                                $i = 1;
                                foreach ($profits as $new) {
                                    ?>
                                    <tr class="gc_row">
                                        <td><?php echo $this->non_profit_model->convert_id($new->id); ?></td>
                                        ...
                                        <td width="41%">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/non_profit/delete/' . $new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete') ?></a>
...
<?php if (isset($profits)): ?>
    ...
    $i = 1;
    foreach ($profits as $new) {
        $profit = $this->non_profit_model->get_non_profits_by_id($new->id);
        ?>
        <!-- Modal -->
                                ...
                                if ($doc->field_type == 1) { //testbox
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <?php $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $profit->id . "' AND form = '" . $doc->form . "' ")->row(); ?>		
                                ...
                                if ($doc->field_type == 2) { //dropdown list
                                    ...
                                    ?>	<div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">	
                                                <?php $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $profit->id . "'  ")->row(); ?>	
                                                <?php
                                                $values = array();
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">	
                                                ...
                                                <?php foreach ($values as $key => $val) { ?>
                                                    <?php
                                                    $x = "";
                                                    $result = $CI->db->query("select * from rel_form_custom_fields where custom_field_id = '" . $doc->id . "' AND table_id = '" . $profit->id . "' AND form = '" . $doc->form . "' ")->row();
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="name" style="clear:both;"><?php echo lang('name') ?></label>
                                            <input type="text" name="name" value="<?php echo $profit->name ?>" class="form-control name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="email" style="clear:both;"><?php echo lang('email') ?></label>
                                            <input type="text" name="email" value="<?php echo $profit->email ?>" class="form-control email">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="username" style="clear:both;"><?php echo lang('username') ?></label>
                                            <input type="text" name="username" value="<?php echo $profit->username ?>" class="form-control username">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="contact" style="clear:both;"><?php echo lang('phone') ?></label>
                                            <input type="text" name="contact" value="<?php echo $profit->contact ?>" class="form-control contact">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label for="contact" style="clear:both;"><?php echo lang('address') ?></label>
                                            <textarea name="address"  class="form-control address"><?php echo $profit->address ?></textarea>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content ff">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="addlabel"><?php echo lang('add'); ?> <?php echo lang('profit') ?></h4>
            </div>
            <div class="modal-body">
                <div id="err">  
                    <?php
    ...
    <script type="text/javascript">
        $("#add_form").submit(function (event) {
            ...
            call_loader_ajax();
            $.ajax({
                url: '<?php echo site_url('admin/non_profit/add') ?>',
                type: 'POST',
                data: form.serialize(),
        ...
        $(".update").click(function (event) {
            ...
            call_loader_ajax();
            $.ajax({
                url: '<?php echo site_url('admin/non_profit/edit') ?>/' + id,
                type: 'POST',
                data: form.serialize(),
